...
if (isset($_POST['add'])) {
    ...
    $sql = "INSERT INTO users (name, address, phone, email, imgName, password)
            VALUES ('$name', '$location', '$phone', '$email', '$imgName', '$password')";

    $result = mysqli_query($con, $sql);
    if ($result) {
        $msg = "<p class='alert alert-success'>User Inserted Successfully</p>";
    } else {
        $error = "<p class='alert alert-warning'>User Not Inserted Some Error</p>";
    }
}
?>
										...
										<div class="row">
											<div class="col-xl-12">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="address" placeholder="User Address" required>
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-2 col-form-label">Phone</label>
													<div class="col-lg-9">
														<input type="number" class="form-control" name="phone" placeholder="User Phone" required>
													</div>
												</div>
												<div class="form-group row">
