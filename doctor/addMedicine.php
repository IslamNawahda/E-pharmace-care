...
if(isset($_POST['addMedicine']))
{
	...
	$sql = "INSERT INTO `medicine`(`amplitude`, `expiryDate`, `productionDate`, `Effect`, `Barcode`, `Contents`, `toAge`, `Name`, `forUse`, `manufactureCompany`, `Complications`, `Description`, `imageName`) VALUES ('$amplitude', '$expiryDate', '$productionDate', '$Effect', '$barcode', '$Contents', '$toAge', '$Name', '$forUse', '$manufactureCompany', '$Complications', '$Description', '$imageName')";
						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">
										...
										<div class="text-left">
											<input type="submit" class="btn btn-primary"  value="Submit" name="addMedicine" style="margin-left:200px;">
										</div>
									</form>
								</div>
