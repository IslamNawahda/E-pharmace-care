...
if (isset($_POST['add'])) {
    ...
    $sql = "INSERT INTO users (name,  address, phone,email, imgName, password,userType)
            VALUES ('$name','$address','$phone', '$email','$imgName', '$password',2)";

    $result = mysqli_query($con, $sql);
    if ($result) {
        $msg = "<p class='alert alert-success'>Admin Inserted Successfully</p>";
    } else {
        $error = "<p class='alert alert-warning'>Admin Not Inserted Some Error</p>". mysqli_error($con);
    }
}
?>
										...
										<div class="row">
											<div class="col-xl-12">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="email" placeholder="Admin Email" required >
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-2 col-form-label">Address</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="address" placeholder="Admin Address" required>
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-2 col-form-label">Phone</label>
													<div class="col-lg-9">
														<input type="number" class="form-control" name="phone" placeholder="Admin Phone" required>
													</div>
												</div>
												<div class="form-group row">
